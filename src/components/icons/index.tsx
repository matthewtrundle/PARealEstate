...
export function PalmTreeIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      className={cn("text-current", className)}
      width={size}
...
export function BeachIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      className={cn("text-current", className)}
      width={size}
...
export function FishingIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      className={cn("text-current", className)}
      width={size}
      ...
      strokeLinejoin="round"
    >
      <path d="M18 4l-4.5 4.5M4 12c1.5 1.26 3 2 4.5 2 .5 0 1.02-.1 1.5-.24m4-2.52C16 10.74 18.5 10 21 10c-2.5 3.5-4.5 5.5-7 8l-2 2-1.5-1.5" />
      <path d="M4 20h6m3-10a4.38 4.38 0 0 0-1.5 2.5" />
    </svg>
  )
}
